...
export interface Me {
  user: {
     ...
     * once somebody else's play has actually moved the rating. null = no
     * crossing has rated them yet, the population the tile keeps the greeting
     * for anyway. See lastCrossingSwing() in server/src/tournaments.ts.
     */
