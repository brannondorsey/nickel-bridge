...
export default function Board() {
  ...
  // would have without a claim. Announcing over them was the bug: you tap
  // the card that wins a trick and a modal says "E/W CLAIM" before your card
  // has even glided in. Then the ClaimOverlay holds the board for
